...
import EmpLeaveVIewDetail from "../Emptable/EmpLeaveTable/EmpLeaveVIewDetail";
import EmpLeaveAdd from "../Emptable/EmpLeaveTable/EmpLeaveAdd";
const TLLeaveApprove = ({ initialData, headerData }) => {
